...
export default function Payment() {
  ...
  function encontrarTicketsPrincipais(arrayDeObjetos) {
    ...
    const menorPreco = objetosNaoRemotos.reduce(
      (menor, objeto) => (objeto.price < menor.price ? objeto : menor),
      objetosNaoRemotos[0]
    );
    ...
    <>
      ...
      {subscription === true ? (
        !cardPage ? (
          ...
          <PaymentComponent
            info={{
              isRemote: ticketSelected?.isRemote,
              price: total,
              hotel: ticketSelected?.includesHotel,
              ticket: ticket,
            }}
          />
        )
